...
const Logitech = () => {
    ...
    return (
        <div className="relative items-center justify-center mx-auto h-max max-h-max w-full py-12 px-4 lg:px-12 overflow-hidden">
            {/* Background Layers */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                ...
                ></div>
                <div className="absolute top-0 left-0 h-full w-full items-center justify-center bg-black bg-opacity-50 backdrop-blur-md"></div>
