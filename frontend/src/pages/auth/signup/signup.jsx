        ...
        <div className='card border-transparent p-8 gap-4 max-w-md w-full relative bg-black/50 rounded-[40px] backdrop-blur-[20px] overflow-hidden'>
            ...
            <form onSubmit={handleSubmit} className='mx-auto space-y-4 flex flex-col gap-2' action="">
                <div className="relative flex items-center">
                    ...
                    <input name='email' className='pl-10 h-auto w-full px-3 py-2 mt-1 border-transparent font-light bg-[#494949]/50 rounded-[9px] 
                ...
                <div className="relative flex items-center">
                    ...
                    <input name='username' className='pl-10 h-auto w-full px-3 py-2 mt-1 border-transparent font-light bg-[#494949]/50 rounded-[9px] 
                ...
                <div className="relative flex items-center">
                    ...
                    <input name='password' className='pl-10 h-auto w-full px-3 py-2 mt-1 border-transparent font-light bg-[#494949]/50 rounded-[9px] 
                            focus:outline-none focus:ring focus:bg-inherit' type={showPassword ? "text" : "password"}
                ...
                <div className="relative flex items-center">
                    <FiLock className="absolute left-3 text-gray-300" />
                    <input name='confirmPassword' className='pl-10 h-auto w-full px-3 py-2 mt-1 border-transparent font-light bg-[#494949]/50 rounded-[9px] 
                            focus:outline-none focus:ring focus:bg-inherit' type={showConfirmPassword ? "text" : "password"}
